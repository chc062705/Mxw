    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', '\u7537'), ('fumale', '\u5973'), ('baomi', '\u4fdd\u5bc6')], default='baomi', max_length=100, verbose_name='\u6027\u522b')),
                ('adress', models.CharField(blank=True, max_length=150, null=True, verbose_name='\u5730\u5740')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_type', models.CharField(choices=[('register', '\u6ce8\u518c'), ('forget', '\u5fd8\u8bb0\u5bc6\u7801')], max_length=50)),
