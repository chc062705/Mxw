...
class UserAsk(models.Model):
    name=models.CharField(max_length=150,verbose_name="用户姓名")
    mobile=models.CharField(max_length=11,verbose_name="用户手机")
...
class CourseComments(models.Model):
    user=models.ForeignKey(UserProfile,verbose_name='用户姓名')
